...
(std $<0.01$), insensitive to the L2 strength over $\{10^{-4},10^{-3},10^{-2}\}$,
and essentially unchanged under a stricter \emph{image-disjoint} split in which
train/validation/test share no images, ruling out a leakage artifact.
